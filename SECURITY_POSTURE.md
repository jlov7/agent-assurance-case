...
- The quality gate checks ruff, pyright, dependency vulnerability status, Bandit static-analysis findings, codespell, CFF metadata, shell scripts, local Markdown links, and public-artifact hygiene.
