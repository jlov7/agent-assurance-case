...
The `main` branch is protected. Changes should land through pull requests after the required GitHub Actions checks pass: `test`, CodeQL `Analyze Python`, `Verify AAC release fingerprint`, `Quality checks`, and `OpenSSF Scorecard`.
